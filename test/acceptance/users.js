...
describe('users', function(){
  ...
  describe('put /profile', function(){
    it('should edit the profile', function(done){
      request(app)
      .post('/profile')
      .send('_method=put&visible=private&email=bob%40gmail.com&phone=1234567890&photo=photo.url&tagline=so+cool&facebook=facebookurl&twitter=twitterurl')
      .set('cookie', cookie)
      .end(function(err, res){
  ...
  describe('get /profile', function(){
    it('should view the profile', function(done){
      request(app)
      .get('/profile')
      .set('cookie', cookie)
      .end(function(err, res){
